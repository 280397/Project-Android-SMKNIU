...
public class ScanActivity extends AppCompatActivity implements ZXingScannerView.ResultHandler {
    ...
    private static final String TAG = "asw";
...
//         Do something with the result here
         Log.d("lihatinicok", rawResult.getText()); // Prints scan results
...
//                Toast.makeText(ScanActivity.this, "Error", Toast.LENGTH_SHORT).show();
    ...
    private void postSe (String id_user_pjm, String id_barang, String barcode){
        final Call<ResponseData> post = Initretrofit.getInstance().postPinjamSe(id_user_pjm, barcode,id_barang);
        post.enqueue(new Callback<ResponseData>() {
            @Override
            public void onResponse(Call<ResponseData> call, Response<ResponseData> response) {
                Log.d("jmvod", response.body().getMessage());
